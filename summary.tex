\begin{table*}[t] 
    ...
    \begin{tabularx}{\textwidth}{@{} l X l @{}} % \textwidth scales it to the full page width
        ...
        D4.1  & Static PTQ: 74.8\% size reduction (42.7$\to$10.8 MB), 11.3$\times$ CPU speedup (bs=1), 100\% prediction agreement. & Section~\ref{sec:scalable-inference} \\
        D4.2  & Peak throughput at bs=16 (170.8 img/s). Saturates due to CPU cache limits. Compute-bound up to bs=16, memory-bound beyond. & Section~\ref{sec:scalable-inference} \\
