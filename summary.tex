\begin{table*}[t] 
    ...
    \begin{tabularx}{\textwidth}{@{} l X l @{}} % \textwidth scales it to the full page width
        ...
        D7.2  & Gradient ascent unlearning reduces digit 7 accuracy from 96.9\% to 0\%. Collateral damage to remaining classes (97.5\%$\to$63.2\%). Shows information entanglement challenge. & Section~\ref{sec:post-deployment} \\
        D8.1  &  & \\
        D8.2  &  & \\
        \bottomrule
    \end{tabularx}
