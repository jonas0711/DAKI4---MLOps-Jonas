\begin{table*}[t] 
    ...
    \begin{tabularx}{\textwidth}{@{} l X l @{}} % \textwidth scales it to the full page width
        ...
        D8.1  & Learned from three other groups' pipelines: a Vision Transformer with a 65\% accuracy gate, Great Expectations data validation with hashed Singularity container caching, and a training/serving split using ONNX and FastAPI. Guest lecture topics noted briefly. & Section~\ref{sec:guest-lecture} \\
        \bottomrule
    \end{tabularx}
\end{table*}
