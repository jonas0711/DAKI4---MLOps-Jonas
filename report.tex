...
MLOps pipeline Github link: \url{https://github.com/jonas0711/DAKI4---MLOps-Jonas}
}
\maketitle
...
% TODO: Beskriv dit valgte projekt her
For this course, I have selected [INDSÆT PROJEKT NAVN] as the foundation for building an MLOps pipeline. The project involves [BESKRIV KORT HVAD PROJEKTET GØR].

\textbf{Project specifications:}
\begin{itemize}
    \item \textbf{Model type}: [f.eks. CNN, Transformer, etc.]
    \item \textbf{Task}: [f.eks. Image classification, Object detection, etc.]
    \item \textbf{Dataset}: [DATASÆT NAVN OG STØRRELSE]
    \item \textbf{Framework}: PyTorch / TensorFlow
\end{itemize}

The project repository is available at: \url{https://github.com/jonas0711/DAKI4---MLOps-Jonas}
...
\begin{table}[h]
\centering
\caption{Model Card for [MODEL NAVN]}
\label{tab:modelcard}
\begin{tabularx}{\linewidth}{@{} l X @{}}
\toprule
\textbf{Field} & \textbf{Value} \\
\midrule
\textbf{Model Name} & [INDSÆT] \\
\textbf{Version} & 1.0.0 \\
\textbf{Date} & [DATO] \\
\midrule
\multicolumn{2}{l}{\textbf{Code}} \\
Repository & \url{https://github.com/jonas0711/DAKI4---MLOps-Jonas} \\
Commit Hash & [INDSÆT COMMIT HASH] \\
Branch & main \\
\midrule
\multicolumn{2}{l}{\textbf{Data}} \\
Dataset & [DATASÆT NAVN] \\
...
Known Biases & [BESKRIV EVENTUELLE BIASES] \\
Limitations & [BESKRIV BEGRÆNSNINGER] \\
Intended Use & [FORMÅL] \\
Out-of-Scope Use & [HVAD BØR MODELLEN IKKE BRUGES TIL] \\
\bottomrule
\end{tabularx}
\end{table}
